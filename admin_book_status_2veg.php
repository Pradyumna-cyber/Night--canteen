	...
	<div style="margin-left:25%;padding:1px 16px;height:1000px;">
		<p style="margin-left: 10%; margin-top: 5%; font-size: 28px;"></p>
			<table class="basic_box">
				<tr>
					<td colspan="6"><p style="font-size: 28px; text-align: center; text-decoration: underline;"><b>Admin booking Status</b></p>
				</td>
				<tr>
					<th>Booking ID</th>
					<th>Reg No</th>
				...
				<?php
					...
					$sql1 = "SELECT * from user_menu_book";
			...
			<table class="basic_box">
				<tr>
					...
					<td colspan="2">
						<form action="confirm_menu_veg2.php" method="post">
				...
				<tr>
					...
					<td style="text-align: center;"><button type="submit">Confirm</button>
  					<button type="submit" formaction="cancel_request.php">Cancel Booking</button></td></form>	
				</tr>
			</table>
		</div>
	</body>
